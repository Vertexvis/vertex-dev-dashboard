...
async function get(req: NextIronRequest): Promise<ErrorRes | GetRes<SceneViewStateData>> {
...
async function create(req: NextIronRequest): Promise<ErrorRes | CreateViewStateRes> {
